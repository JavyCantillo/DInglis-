...
<body id="body">
    ...
    <nav class="NavBarra">
        <ul>
            ...
            <li><a class="active" style="color: black;" href="#">Contacto</a></li>
        ...
        <div class="div_texto">
            <p>
                Acá está la información para contactar a los creadores de Dinglis
            </p>
        </div>
        <div style="margin-top: 25px;" class="div_texto">
            Jaider Rojas Alvarez - jaiderrojasalvarez@pascualbravo.edu.co <br>
            Stiven Javier Guzmán Otero - stivenjavierguzmanotero@pascualbravo.edu.co <br>
            Javier Cantillo de la Asunción - javiercantillodelaasuncion@pascualbravo.edu.co<br>
        </div>

        <img class="imagen" width="384" height="384" src="images/email.png" alt="logo">
        <br>
        <br>
